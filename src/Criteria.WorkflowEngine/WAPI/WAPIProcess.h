...
* @param sWorkflowName è una stringa contiene il nome del modello del processo da istanziare
* @param sProcess è la stringa contenente il processo creato
* @throws
* @see
* @return
* @returns
...
* il risultato della funzione o operazione sottoforma di stringa xml successivamente 
* da leggere ed interpretare.
* @param iProcessID è un intero che rappresenta l'istanza di un processo esistente
* @throws
* @see
* @return
* @returns
...
* da leggere ed interpretare.
* @param iProcessID è un intero che rappresenta l'istanza di un processo esistente
* @param acStatus è una stringa xml che contiene una activity del processo in corso
