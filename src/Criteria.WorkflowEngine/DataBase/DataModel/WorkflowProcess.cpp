...
void WorkflowProcess::setRecord(ResultSetRecord& record)
{
	...
	//
	record.add( new ResultSetField (SQLWorkflowProcess::TRANSITIONS_FIELD.c_str(), vTransitions.getXMLString(0).c_str() ));
	record.add( new ResultSetField (SQLWorkflowProcess::MESSAGES_FIELD.c_str(), vMessages.getXMLString(0).c_str() ));
