...
#include "DataModel/Attributes.h"
#include "DataModel/Behaviour.h"
...
namespace WorkflowEngine
{
	namespace Criteria
	{
		...
		{
			/**
			* La classe base della struttura ereditaria che implementa le funzionalità  
			...
			* PROCESS TYPE e SUBFLOW EXIT : funzionalità per gestire un processo dipendente da un processo padre 
			* CONDITION TYPE e ITERATION TYPE : intoducono le funzionalità per la gestione di pattern di workflow
			* SPECIAL TYPE e SPECIAL TYPE CATCHER : intoducono le funzionalità per la gestione di pattern di workflow multi branch
