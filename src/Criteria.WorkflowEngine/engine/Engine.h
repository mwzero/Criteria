...
namespace WorkflowEngine
{
	namespace Criteria
	{
		namespace Core
		{
			...
			*nonché a lanciare la richiesta direttamente o prelevandola da una serie di 
			...
			*/
			class ENGINE_API Engine
			{
				public:
					...
					* @endcode
					* @sa
					* @param lProcessID è l'identificativo del processo da startare
					* @throws
					* @see execute()
					* @return
					* @returns
					...
					* @param *acStatus è la activity da cui ripartire
					* @throws
					* @see
					* @return
					* @returns
					...
					* @endcode
					* @sa
					* @param idRequest è il codice di richiesta
					* @throws
					* @see
