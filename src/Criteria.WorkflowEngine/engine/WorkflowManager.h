...
namespace WorkflowEngine
{
	namespace Criteria
	{
		namespace Core
		{
			...
			*
			* WorkflowList è il vettore che contiene tutte le istanze di workflow attive.
			*
			* @code
			* @endcode
			* @sa
			...
			*/
			class WorkflowManager
			{
				public:
					...
					* @endcode
					* @sa
					* @param wf è l'istanza di workflow da aggiungere di tipo Workflow (Puntatore)
					* @throws
					* @see
					* @return
					* @returns
					...
					* @endcode
					* @sa
					* @param workflowID è il numero di istanza da distruggere
					* @throws
					* @see
					* @return
					* @returns
					...
					* @endcode
					* @sa
					* @param workflowID è il numero di istanza da cercare
					* @throws
					* @see
					* @return IWorkflow* è il contenuto del vettore di 
					* workflow attivi corrispondente all'istanza cercata 
					* (IWorkflow* è il puntatore all'area di memoria che contiene il workflow cwrcato)
					* @returns
					*/
					...
					* creerà il thread che realizza fisicamente lo start.
					*
					* @code
					* @endcode
					* @sa
					* @param workflowID è il numero di istanza da startare
					* @throws
					* @see
					* @return IWorkflow* è il puntatore all'area di memoria che contiene il workflow avviato
					* @returns
					*/
					...
					* @endcode
					* @sa
					* @param workflowID è il numero di istanza da stoppare
					* @throws
					* @see
					* @return IWorkflow* è il puntatore all'area di memoria che contiene il workflow da cessare
					* @returns
					*/
					...
					* @endcode
					* @sa
					* @param workflowID è il numero di istanza da sospendere
					* @throws
					* @see
					* @return IWorkflow* è il puntatore all'area di memoria che contiene il workflow da sospenere
					* @returns
					*/
					...
					* @endcode
					* @sa
					* @param IWorkflow* è il puntatore all'area di memoria che contiene il workflow
					* @param bDetach è il booleano che determina se il thread che si vuole lanciare
					* deve o meno essere sincronizzato
					* @throws
					* @see
					* @return WorkFlowThread* è il thread di workflow lanciato (puntatore alla'area di memoria del thread creato)
					* @returns
					*/
