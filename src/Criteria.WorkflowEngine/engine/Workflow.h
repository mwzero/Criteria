...
#include "DataModel/Transition.h"
#include "DataModel/Activity.h"
#include "DataModel/FormalParameters.h"
#include "DataModel/FormalParameter.h"
using namespace DataManager::Panorama;

#include "bOS/bOSMutex.h"
#include "bOS/bOSSemaphore.h"
#include "bOS/bOSSmartLocker.h"
...
namespace WorkflowEngine
{
	namespace Criteria
	{
		namespace Core
		{
			...
			*
			* Inoltre workflow è la classe che lancia fisicamente le eccezioni che provengono dall'engine.
			* La classe è in grado di lanciare eventi (eredita EventMaker):
			*
			...
			*/
			class Workflow : public IWorkflow, public WorkflowEngine::Criteria::Event::EventMaker
			{
				public:
					...
					* @endcode
					* @sa
					* @param task è la acticity da cui partire con il processo
					* @throws
					* @see init()
					* @return
					* @returns
					...
					* @endcode
					* @sa
					* @param status è la stringa che contiene l'activity da cui partire
					* @throws
					* @see
					* @return
					* @returns
					...
					* @endcode
					* @sa
					* @param Level è l'intero che indica il livello
					* @throws
					* @see
					* @return
					* @returns
					...
					* @endcode
					* @sa
					* @param lValue è l'id del processo da associare come padre
					* @throws
					* @see
					* @return
					* @returns
					...
					* @endcode
					* @sa
					* @param sValue è il nome della task da conservare
					* @throws
					* @see
					* @return
					* @returns
					...
					* @throws
					* @see
					* @return true se il workflow è in stato stop
					* @returns
					*/
				...
				private:
					...
					* @endcode
					* @sa
					* @param task è la acticity da eseguire.
					* @throws
					* @see
					* @return
					* @returns
					...
					*/
					...
					//è stato generato da un task di pattern.
