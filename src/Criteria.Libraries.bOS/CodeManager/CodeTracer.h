...
namespace CodeManager
{
	...
	private:
		...
		std::string sOldFileName;
		std::string sVeryOldFileName;

		void createTraceFile();
		std::string indentbyThread(int iThreadId, int iItemAction);
	...
	public:
		...
		*/
		...
		static std::string CODEITEM_IN;
		static std::string CODEITEM_OUT;
