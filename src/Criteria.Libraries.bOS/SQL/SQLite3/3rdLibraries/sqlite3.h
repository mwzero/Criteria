...
#define SQLITE_TOOBIG      18   /* std::string or BLOB exceeds size limit */
...
/*
** CAPI3REF: Formatted std::string Printing Functions
**
...
** parameter is less than -1 or greater than std::string then the behavior is
** undefined.
**
...
struct sqlite3_index_info {
  ...
  char *idxStr;              /* std::string, possibly obtained from sqlite3_malloc */
...
/*
** CAPI3REF: std::string Comparison
**
