...
std::string Date::getShortMonthName( int month )
{
    if ( month < 1 || month > 12 )
	    month = 1;
...
std::string Date::getShortDayName( int weekday )
{
    std::string s = "";
...
std::string Date::getLongMonthName( int month )
{
    std::string s = "";
...
std::string Date::getLongDayName( int weekday )
{
    std::string s = "";
    if ( weekday < 1 || weekday > 7 )
	    weekday = 1;
...
std::string Date::toString()
{
    ...
    std::string formatText = "%02i/%02i/%04i";
